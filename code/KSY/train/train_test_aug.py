...
from utils.data_augmentation import noise_augmentation
...
class Dataloader(pl.LightningDataModule):
    ...
    def setup(self, stage='fit'):
        if stage == 'fit':
            ...
            # 데이터 augmentation
            train_data_aug = noise_augmentation(train_data,op="op2",target=self.target_columns)

            # 학습데이터 준비
            # train_inputs, train_targets = self.preprocessing(train_data)
            train_inputs, train_targets = self.preprocessing(train_data_aug)
...
if __name__ == '__main__':
    ...
    logger = WandbLogger(project="level1", group='imbalanced data', entity='moth2aflame', name='aug2')
    ...
    # 학습이 완료된 모델을 저장합니다.
    torch.save(model, '/data/ephemeral/home/level1/ksy/models/model_aug2.pt')
