...
if __name__ == '__main__':
   ...
   # parser.add_argument('--num_split', default='5', type=int)
    ...
    logger = WandbLogger(project="level1", group='model', entity='moth2aflame', name='koelectra')
    ...
    checkpoint_callback = ModelCheckpoint(
            monitor="val_pearson",
            save_top_k=1,
            dirpath="/data/ephemeral/home/level1/ksy/callback/",
            filename=filename,
    ...
    # 학습이 완료된 모델을 저장합니다.
    torch.save(model, '/data/ephemeral/home/level1/ksy/models/model_koelectra.pt')