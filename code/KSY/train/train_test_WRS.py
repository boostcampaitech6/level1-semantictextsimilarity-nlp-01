...
if __name__ == '__main__':
    ...
    logger = WandbLogger(project="level1", group='imbalanced data', entity='moth2aflame', name='suyeon2')
    ...
    # 학습이 완료된 모델을 저장합니다.
    torch.save(model, '/data/ephemeral/home/level1/ksy/models/model_WRS.pt')
