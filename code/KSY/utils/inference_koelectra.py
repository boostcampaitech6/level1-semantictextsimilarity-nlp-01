...
if __name__ == '__main__':
   ...
   # parser.add_argument('--num_split', default='5', type=int)
    ...
    # Inference part
    # 저장된 모델로 예측을 진행합니다.
    model = torch.load('/data/ephemeral/home/level1/ksy/models/model_koelectra.pt')
    ...
    output = pd.read_csv('/data/ephemeral/home/level1/data/sample_submission.csv')
    output['target'] = predictions
    output.to_csv('/data/ephemeral/home/level1/ksy/outputs/output_koelectra.csv', index=False)
